...
namespace Asp.NetCore_REACT.Controllers
{
    ...
    {
        private readonly AspNetCore_REACTContext _context;

        public ContinentsController(AspNetCore_REACTContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Continent.OrderBy(c=>c.Name).ToListAsync();
        }
